\chapter{Requirement definition}
\section{Introduction to earth observation payload}
The payload is the combination of hardware and software on the spacecraft that interact with the subject (the portion of the outside world that the spacecraft is looking at of interacting with ) to accomplish the mission objectives. \\
In this chapter the overall process of payload design and sizing , with emphasis on the background and process of optical observation payloads.
...
\begin{itemize}
	...
	\item Spectral bands: Define the required spectral bands to capture information across 	different parts of the electromagnetic spectrum. This may include visible, near-infrared, and shortwave infrared bands for vegetation health analysis and other
	applications.
